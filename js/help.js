...
export const FIELD_HELP = Object.freeze({
  ...
  "Escala de trabalho": "Define em quais dias o fiscal normalmente trabalha. A agenda diária pode registrar exceções, como férias, folgas ou trabalho em um dia diferente.",
  "Tipo de escala": "Use dias fixos para rotinas semanais, como segunda a sexta. Use ciclo para regimes contínuos, como 10 dias de trabalho por 4 de folga.",
  "Jornada diária (h)": "Quantidade normal de horas disponíveis em cada dia de trabalho deste fiscal, entre 15 minutos e 12 horas.",
  "Dias habituais de trabalho": "Dias em que o fiscal trabalha numa escala semanal fixa. O calendário operacional permite selecionar de segunda-feira a sábado.",
  "Dias consecutivos de trabalho": "Quantidade de dias corridos trabalhados antes do período de folga no regime por ciclo.",
  "Dias consecutivos de folga": "Quantidade de dias corridos de folga após cada período de trabalho no regime por ciclo.",
  "Início do ciclo de trabalho": "Uma data conhecida como o primeiro dia trabalhado do ciclo. O sistema usa essa referência para calcular automaticamente trabalho e folga nas demais datas.",
  ...
  "Horas disponíveis": "Capacidade excepcional para o dia. O registro substitui a escala normal nessa data e aceita até 12 horas.",
  "Horas disponíveis para fiscalização": "Capacidade excepcional para o dia. O registro substitui a escala normal nessa data e aceita até 12 horas.",
  ...
  "Jornada de um fiscal-dia (h)": "Número de horas usado como referência para converter capacidade e demanda em fiscal-dias. A jornada real é cadastrada individualmente em cada fiscal.",
...
export const CONCEPT_HELP = Object.freeze({
  "Capacidade disponível": "Soma das horas que os fiscais ativos podem trabalhar de segunda a sábado, respeitando a escala individual, a jornada diária e os bloqueios da agenda.",
